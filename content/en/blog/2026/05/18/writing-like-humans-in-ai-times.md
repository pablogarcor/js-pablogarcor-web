...
We are entering in a weird era where we dont really know if we are reading something written by a human or a machine. I know knowledge is knowledge and emotions are emotions even if they are machine generated but
sometimes, when I read, watch or talk to somebody, I want to know that the other part is a real person with his own problems and life and not just a soul less algorithm that choose the perfect output to a given prompt
